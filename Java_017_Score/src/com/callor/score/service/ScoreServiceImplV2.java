...
public class ScoreServiceImplV2 extends ScoreServiceImplV1Ex {
	...
	protected String[] sjList;
	protected Integer[] ssList;
	...
	public ScoreServiceImplV2() {
		...
		sjList = new String[] { "국어", "영어", "수학" };
		ssList = new Integer[sjList.length];
	...
	public void inputScore() {
		...
		while (true) {
			...
			if (strName.equals("")) {
				System.out.println("학생의 이름은 반드시 입력");
				continue;
			}
			break;
		}
		...
		scoreVO.setKor(ssList[국어]);
		scoreVO.setEng(ssList[영어]);
		scoreVO.setMath(ssList[수학]);
