 ...
 * 4. 재정의(Override)
 * 
 * 모델링된 socreVO를 실제로 사용할때는 객체로 생성한다
 * ScoreVO scoreVO = new ScoreVO()
 * 필요할때마다 객체로 생성하고, 데이터를 Setter하고
 * 연산을 수행한후 데이터를 Getter 하는 방식으로 활용한다.
 * 
...
public class ScoreVO {
	...
	/*
	 * VO 클래스를 모델링하고
	 * 변수를 private으로 선언 하였다 : 정보은닉
	 * 은닉된 변수에 접근하기 위하여 getter, setter method를 생성
	 * 
	 * getter와 setter를 생성학도 봤더니
	 * 총점(total)과 평균(avg)은 점수가 입력되면 항상
	 * 계산되어야 하는 항목이다 
