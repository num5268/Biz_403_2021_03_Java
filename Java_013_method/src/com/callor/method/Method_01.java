...
public class Method_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		System.in(크보드 입력 장치)를 연결할 수있도록
		 * 		매개변수에 정보를 전달해주어야 한다
		 */
		...
		if(int1 % 3 == 0) {
			...
			System.out.println(int1 + "은 3의 배수가아님");
		}
		
		/*
		 * 어떤수가 짝수인가를 조건검사하고
		 * 짝수이면 짝수이다 라고 표현하고
		 * else 이면 홀수이다 라고 표현하고
		...
		if(int1 % 2 == 0) {
			...
			System.out.println(int1 + "는 홀수이다");//이렇게 표현x
			System.out.println(int1 + "는 짝수가 아니다");//아니다 라는 표현
		}
