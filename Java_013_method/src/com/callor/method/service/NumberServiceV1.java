...
public class NumberServiceV1 {
	 ...
	 * 		int와 Integer가 있다
	 * 
	 * return 의 두번째 조건에 "아니면 null 값을 return"하라
	 * 		라는 지시가 있으므로 int 형은 사용할수 없다/
	 * 
	 * void 키워드 
	 * 		method에 return 명령이 꼭 없어도 되는 경우
	 * 
	 * 이 method는 정수형 3의 배수 또는
	 ...
	 * 이 method에 return 명령문만으로 처리가 되지 않고
	...
	public NumberServiceV1() {
		...
		public Integer inputNum() {
			...
			if(num2 % 3 == 0 ) {
				 ...
				 * 		Integer 이다
				 * 그런데 여기서 return하는 num2변수의 type은
				 * 		int 형이다
				 * 별다는 문제를 일으키거나 하지는 않지만
				 * 		실제 코드가 작동될때는
				 * 		int 형을 Integer wrapper클래스 형으로
				 * 		변화하는 과정이 일어난다
				 */
				return num2;
			}
