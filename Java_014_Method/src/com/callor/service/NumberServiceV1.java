...
public class NumberServiceV1 {
	...
	public Integer addNum(int num1, int num2) {
		...
		//		return문은 한번만 쓰자 라는 정통적인 패턴이 있다
		//		전통적인 패턴을 지키는 코드 예
		//Integer sum = null;
		//if( (num1 +num2) == 0 ) {
		//	sum = num1+ num2;
